...
public class traPhongCuaXien extends JFrame implements chiPhiPhatSinh_Dialog.ChiPhiPhatSinhListener {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					traPhongCuaXien window = new traPhongCuaXien(ddp);
	...
	public traPhongCuaXien(DonDatPhong ddp) {
			...
			buttonPanelEditor.getDetailButton().addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					if (row != -1) {
						...
						phieuDichVu_Dialog dialog = new phieuDichVu_Dialog(maPhieu, loaiDV, ngayLapPhieu, traPhongCuaXien.this, true);
		...
		table_TinhChiPhiPhatSinh.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (row >= 0) {
					...
					chiPhiPhatSinh_Dialog dialog = new chiPhiPhatSinh_Dialog(currentDonDatPhong.getMaDonDatPhong(), row,maPhong, loai.getTenLoai(), traPhongCuaXien.this, true);
					dialog.setChiPhiPhatSinhListener(traPhongCuaXien.this);

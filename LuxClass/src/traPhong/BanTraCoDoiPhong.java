...
public class BanTraCoDoiPhong extends JFrame implements chiPhiPhatSinh_Dialog.ChiPhiPhatSinhListener {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					BanTraCoDoiPhong window = new BanTraCoDoiPhong(ddp);
	...
	public BanTraCoDoiPhong(DonDatPhong ddp) {
			...
			buttonPanelEditor.getDetailButton().addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					if (row != -1) {
						...
						phieuDichVu_Dialog dialog = new phieuDichVu_Dialog(maPhieu, loaiDV, ngayLapPhieu, BanTraCoDoiPhong.this,
								true);
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (row >= 0) {
					...
					chiPhiPhatSinh_Dialog dialog = new chiPhiPhatSinh_Dialog(currentDonDatPhong.getMaDonDatPhong(), row,
							maPhong, loai.getTenLoai(), BanTraCoDoiPhong.this, true);
					dialog.setChiPhiPhatSinhListener(BanTraCoDoiPhong.this); // Thiết lập donDatPhong làm listener
